...
A small polish release focused on discoverability.

### Changed
- `bdf --help` now prints a structured usage screen (USAGE / OPTIONS / COMMANDS)
  that documents every flag and subcommand (with aliases) at a glance, instead of
  a flat list of example commands.
...
[1.1.1]: https://github.com/vaproh/dontforget/compare/v1.1.0...v1.1.1
